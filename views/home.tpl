...
<section class="container">
    ...
    <h1>Characters</h1>
        ...
        <article class="span4 char_canvas">
            <h2><a href="/character/{{character['_id']}}">{{character['name']}}</a></h1>
            <a style="width: 260px" href="#" class="thumbnail">
        ...
        %end
        <!-- End of DB-->
        <br><a style="margin-top: 20px;" href="/new_character" class="btn btn-info">New Character</a>
    <footer></footer>
    </div>
</section>
